...
/**
	...
	class Observable2 {
	public:
		tscb::signal_proxy<void(int, int)> &on_value_change() noexcept
		{
			return value_change;
		}
...
public:
	...
	tscb::signal_proxy<void()> &on_destroy() const {return destroy_notifier;}
...
private:
	...
	mutable tscb::signal<void()> destroy_notifier;
	int width, height;
};
\endcode
